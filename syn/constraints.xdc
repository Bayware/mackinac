...
set_input_delay -clock [get_clocks clk_mac] 2.0 [get_ports {rx_axis_t*} ]

set_output_delay -clock [get_clocks clk_mac] 1.0 [get_ports {tx_axis_t*} ]
...
#set_multicycle_path -setup -end -from [get_pins {u_*/u_pio_*mem*/app_mem_rdata_reg[*]/C} ] -to [get_pins {u_pio_bus/lat_pio_rdata_reg*/D}] 4
#set_multicycle_path -setup -end -from [get_pins {u_*/u_*_mem_*/u_pio_*mem*/app_mem_rdata_reg*/C} ] -to [get_pins {u_pio_bus/lat_pio_rdata_reg*/D}] 4
